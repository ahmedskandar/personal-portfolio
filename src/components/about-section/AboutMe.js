    ...
    <section>
      ...
      <div className="flex flex-col gap-10 md:flex-row md:gap-16">
        <div className="flex w-full justify-end sm:justify-center md:w-1/2 md:order-2 lg:w-4/12 lg:mx-auto">
          <Icon
            role="img" //Accessibility. Indication of the svg icon to be treated as an image
            className="h-4/5 w-4/5 mx-auto sm:h-2/4 sm:w-2/4 md:mr-5 md:w-full md:h-full"
          />
        </div>
        <div className="bg-gold w-[90%] p-8 relative rounded-r-2xl text-white sm:w-4/5 md:max-w-none md:hover:scale-105 md:transition md:duration-200 md:self-center md:w-1/2 md:p-12 md:order-1 lg:py-24 lg:px-14">
