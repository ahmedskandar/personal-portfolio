  ...
  return (
    <section>
      ...
      <div className="flex flex-col gap-10 md:flex-row md:gap-16">
        ...
        <div className="bg-gold w-full max-w-2xl p-8 relative rounded-r-2xl text-secondary sm:max-w-3xl md:max-w-none md:self-center md:w-1/2 md:p-12 md:order-1 lg:py-24 lg:px-14">
