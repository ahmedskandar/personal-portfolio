  ...
  return (
    <section>
      ...
      <div className="flex flex-col gap-10 md:flex-row md:gap-16">
        ...
        <div className="bg-gold w-4/5 p-8 relative rounded-r-2xl text-secondary md:self-center sm:w-3/4 md:w-1/2 md:p-12 md:order-1 lg:py-24 lg:px-14">
          <p className="text-xl md:text-2xl lg:leading-10 lg:text-3xl">
