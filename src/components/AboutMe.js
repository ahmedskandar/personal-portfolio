  ...
  return (
    <section>
      ...
      <div className="flex flex-col gap-10 md:flex-row md:gap-16">
        ...
        <div className="bg-gold w-[90%] p-8 relative rounded-r-2xl text-secondary sm:w-4/5 md:max-w-none md:self-center md:w-1/2 md:p-12 md:order-1 lg:py-24 lg:px-14">
