...
function HeroSection() {
  ...
  return (
    <section
      ...
      // style={sectionStyle}
      className="w-full h-[92vh] flex flex-col justify-between bg-cover bg-no-repeat bg-[95%] bg-[url('../public/assets/images/landing-page-mobile.webp')] md:bg-[url('../public/assets/images/landing-page-bg.webp')] md:bg-fixed md:h-screen"
    >
      <HeroHeader />
      <HeroContent />
      <HeroFooter />
